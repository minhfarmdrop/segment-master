view: delivery_made {
  sql_table_name: v5.delivery_made ;;
  ...
  dimension: driver_firstname {
    type: string
    sql: ${TABLE}.driver_firstname ;;
  }

  dimension: driver_profile_image_url {
    type: string
    sql: ${TABLE}.driver_profile_image_url ;;
  }
  ...
  dimension: eligible_for_driver_review {
    type: yesno
    sql: ${TABLE}.eligible_for_driver_review ;;
  }
