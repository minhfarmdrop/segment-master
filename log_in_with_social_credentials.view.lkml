view: log_in_with_social_credentials {
  sql_table_name: v5.log_in_with_social_credentials ;;
  ...
  dimension: login_attempt_type_enum {
    type: number
    sql: ${TABLE}.login_attempt_type_enum ;;
  }
  ...
  dimension: social_token {
    type: string
    sql: ${TABLE}.social_token ;;
  }

  dimension: social_user_id {
    type: string
    sql: ${TABLE}.social_user_id ;;
  }
