view: removed_promotion {
  sql_table_name: v5.removed_promotion ;;
  ...
  dimension: coupon_eligibility {
    type: string
    sql: ${TABLE}.coupon_eligibility ;;
  }

  dimension: coupon_eligibilty {
    type: string
    sql: ${TABLE}.coupon_eligibilty ;;
  }
  ...
  dimension: way_coupon_added {
    type: string
    sql: ${TABLE}.way_coupon_added ;;
  }
