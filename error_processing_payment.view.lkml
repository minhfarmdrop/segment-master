view: error_processing_payment {
  sql_table_name: v5.error_processing_payment ;;
  ...
  dimension: backend_message_description {
    type: string
    sql: ${TABLE}.backend_message_description ;;
  }

  dimension: backend_returned_a_custom_error {
    type: string
    sql: ${TABLE}.backend_returned_a_custom_error ;;
  }
  ...
  dimension: error_response_type {
    type: string
    sql: ${TABLE}.error_response_type ;;
  }
