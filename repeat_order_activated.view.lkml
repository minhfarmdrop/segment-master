view: repeat_order_activated {
  sql_table_name: v5.repeat_order_activated ;;
  ...
  dimension: one_off_items_count {
    type: string
    sql: ${TABLE}.one_off_items_count ;;
  }
  ...
  dimension: weekly_items_count {
    type: string
    sql: ${TABLE}.weekly_items_count ;;
  }

  dimension: weekly_order_id {
    type: string
    sql: ${TABLE}.weekly_order_id ;;
  }
