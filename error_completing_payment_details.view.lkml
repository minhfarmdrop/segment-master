view: error_completing_payment_details {
  sql_table_name: v5.error_completing_payment_details ;;
  ...
  dimension: error_column {
    type: number
    sql: ${TABLE}.error_column ;;
  }
  ...
  dimension: error_source_url {
    type: string
    sql: ${TABLE}.error_source_url ;;
  }
