view: setup_a_repeat_order {
  sql_table_name: v5.setup_a_repeat_order ;;
  ...
  dimension: most_ordered {
    type: string
    sql: ${TABLE}.most_ordered ;;
  }
  ...
  dimension: want_every_week {
    type: string
    sql: ${TABLE}.want_every_week ;;
  }
