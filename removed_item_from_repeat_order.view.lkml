view: removed_item_from_repeat_order {
  sql_table_name: v5.removed_item_from_repeat_order ;;
  ...
  dimension: your_latest_order {
    type: string
    sql: ${TABLE}.your_latest_order ;;
  }

  dimension: your_most_ordered {
    type: string
    sql: ${TABLE}.your_most_ordered ;;
  }
