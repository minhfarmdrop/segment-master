view: shopping_list_renamed {
  sql_table_name: v5.shopping_list_renamed ;;
  ...
  dimension: new_list_name {
    type: string
    sql: ${TABLE}.new_list_name ;;
  }

  dimension: old_list_name {
    type: string
    sql: ${TABLE}.old_list_name ;;
  }
