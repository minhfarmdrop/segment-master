view: added_all_items_to_basket_recipe {
  sql_table_name: v5.added_all_items_to_basket_recipe ;;
  ...
  dimension: deliverable_item_count {
    type: string
    sql: ${TABLE}.deliverable_item_count ;;
  }
  ...
  dimension: ingredient_item_count {
    type: string
    sql: ${TABLE}.ingredient_item_count ;;
  }
