view: delivery_slot_cell_selected {
  sql_table_name: v5.delivery_slot_cell_selected ;;
  ...
  dimension: deliveryslot_id {
    type: string
    sql: ${TABLE}.deliveryslot_id ;;
  }

  dimension: dropcycle_id {
    type: string
    sql: ${TABLE}.dropcycle_id ;;
  }
