view: postcode_checker {
  sql_table_name: v5.postcode_checker ;;
  ...
  dimension: failed_but_capturing_email {
    type: string
    sql: ${TABLE}.failed_but_capturing_email ;;
  }

  dimension: failed_only {
    type: string
    sql: ${TABLE}.failed_only ;;
  }
