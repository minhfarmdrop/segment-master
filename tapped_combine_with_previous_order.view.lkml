view: tapped_combine_with_previous_order {
  sql_table_name: v5.tapped_combine_with_previous_order ;;
  ...
  dimension: basket_order_id {
    type: string
    sql: ${TABLE}.basket_order_id ;;
  }

  dimension: basket_order_number {
    type: string
    sql: ${TABLE}.basket_order_number ;;
  }
  ...
  dimension: previous_order_id {
    type: string
    sql: ${TABLE}.previous_order_id ;;
  }

  dimension: previous_order_number {
    type: string
    sql: ${TABLE}.previous_order_number ;;
  }
